        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('block.store') }}" id="form1">
                        @csrf
                                                    ...
                                                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                        ...
                                                        <div class="mt-2 grid grid-cols-4 gap-4 gallery-container">
                                                            @forelse ($files as $media)
                                                                <div class="w-20">
                                                                    <img @click="(s) => {console.log(fields[currentRow].content);fields[currentRow].content = s.target.src;s.target.classList.toggle('border-indigo-400')}"
                                                                        src="{{ $media->path }}"
                                                                        alt="{{ $media->name }}"
