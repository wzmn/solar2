                        ...
                        <div class="mb-4" x-data="{
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                                ...
                                <div>
                                    ...
                                    <template x-for="(category, index) in selectedCategories" :key="category.id">
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="ml-2 bg-red-500 hover:bg-red-700 text-white py-1 px-2 rounded"
