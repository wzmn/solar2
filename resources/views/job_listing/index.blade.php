...
<x-app-layout>
    ...
    <div class="py-12">
        ...
        @endif
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-4 p-6 flex">
                <a href="{{ route('jobs.create') }}" class="bg-gray-800 flex justify-start px-4 py-2 rounded-md text-white gap-4">Add New + </a>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="border border-slate-300 px-2">
                                        <div class="flex gap-3 justify-end">
                                            <a class="border-l-2 px-2" href="{{ route('jobs.edit', $item) }}">Edit</a>
                                            <a class="border-l-2 px-2" href="{{ route('jobs.show', $item) }}">View</a>
                                            <form method="POST" action="{{ route('jobs.destroy', $item) }}">
                                                @csrf
                                                @method('DELETE')
