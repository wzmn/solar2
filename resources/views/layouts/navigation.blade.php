        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    <x-dropdown align="center" width="150">
                        <x-slot name="trigger">
                            <button
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('blog.index')" active="request()->routeIs('blog.index')">
                                {{ __('Posts') }}
                            </x-dropdown-link>
                    ...
                    <x-dropdown align="center" width="150">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('testimonials.index')" active="request()->routeIs('testimonials.index')">
                                {{ __('Testimonials') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('solutions.index')" active="request()->routeIs('solutions.index')">
                                {{ __('Solutions') }}
                            </x-dropdown-link>
