...
<?php
$timeline = $seo->blocks->filter(function ($item) {
    return $item->type === 'Timeline';
});
$history = $seo->blocks->filter(function ($item) {
    $item->items = json_decode($item->data);
...
@section('content')
                    ...
                    @if ($overviewContent->type === 'Overview')
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-12 col-lg-5" data-aos="fade-up" data-aos-delay="100">
                                <h2 class="highlight fs-1">{{ $data[1]->content }}</h2>
                                {!! $data[2]->content !!}
                                {{-- 
    ...
    <div class="history d-flex flex-column"
        ...
        <div class="container">
            @foreach ($history->all() as $hist)
            <div class="row mt-5">
                <div class="col mt-5">
                    <h2 data-aos="fade-up" class="highlight mb-5">{{$hist->items[0]->content}}</h2>
                    <h5 data-aos="fade-up">{{$hist->items[1]->content}}</h5>
                    <div class="row history__grid mb-5">
                        <div class="col-12">
                            <p class="history__grid_item text-justify" data-aos="fade-up">{{$hist->items[2]->content}}</p>
                        </div>
                        <div class="col-md-6">
                            <p class="history__grid_item text-justify" data-aos="fade-up">{{$hist->items[3]->content}}</p>
                            <p class="history__grid_item history__grid_item--half text-justify" data-aos="fade-up">{{$hist->items[4]->content}}</p>
                        </div>
                        <div class="col-md-6">
                            <div class="history__grid__gallery history__grid_item--half">
                                <img src="{{$hist->items[5]->content}}" class="img-fluid" data-aos="fade-up"
                                    data-aos-delay="50">
                                <img src="{{$hist->items[6]->content}}" class="img-fluid" data-aos="fade-up"
                                    data-aos-delay="150">
                                <img src="{{$hist->items[7]->content}}" class="img-fluid" data-aos="fade-up"
                                    data-aos-delay="250">
                                <img src="{{$hist->items[8]->content}}" class="img-fluid" data-aos="fade-up"
                                    data-aos-delay="350" alt="Sriram Cables Manufacturing building">
                            </div>
                        </div>

                        <div class="col-12">
                            <p class="history__grid_item history__grid_item--half text-justify" data-aos="fade-up">{{$hist->items[9]->content}}</p>

                        </div>

                        <div class="history__grid_item history__grid__image mb-3">
                            <img src="{{$hist->items[10]->content}}" class="img-fluid" data-aos="fade-up"
                                data-aos-delay="150">
                        </div>
                        <div class="col-md-6">
                            <div class="history__grid_item history__grid_item--half" data-aos="fade-up">
                                {!! $hist->items[11]->content !!}
                                <img src="{{ $hist->items[12]->content }}" class="img-fluid mb-4">
                                <div>
                                    <b>{{ $hist->items[13]->content }}</b>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="history__grid__gallery history__grid_item history__grid_item--half">
                                <img src="{{ $hist->items[14]->content }}" class="img-fluid" data-aos="fade-up"
                                    data-aos-delay="150">
                                <img src="{{ $hist->items[15]->content }}" class="img-fluid" data-aos="fade-up"
                                    data-aos-delay="250">
                                <img src="{{ $hist->items[16]->content }}" class="img-fluid" data-aos="fade-up"
                                    data-aos-delay="350">
                                <img src="{{ $hist->items[17]->content }}" class="img-fluid" data-aos="fade-up"
                                    data-aos-delay="450">
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="timelineCarousel" class="carousel slide" data-bs-ride="false">
                            <div class="carousel-indicators">
                                ...
                                @foreach ($timeline->all() as $timeline)
                                    <?php $data = json_decode($timeline->data);?>
                                    <button type="button" data-bs-target="#timelineCarousel" data-bs-slide-to="{{$loop->index}}"
                                        class="@if ($loop->first) active @endif" aria-current="true"
                                        aria-label="{{$data[0]->content}}"></button>
                                @endforeach
                                <button data-bs-target class="d-none d-md-block"></button>
                                <button data-bs-target class="d-none d-lg-block"></button>
                            ...
                            <div class="carousel-inner mb-5">
                                @foreach ($timeline->all() as $timeline)
                                    <div class="carousel-item flex-column flex-md-row @if ($loop->first) active @endif">
                                        <div class="col-md-4 col-12 mb-4">
                                            <img src="{{ asset('assets/images/slide-1.png') }}" class="img-fluid"
                                                data-aos="fade-up">
                                        </div>
                                        <div class="col-md-8 col-12" data-aos="fade-up">
                                            <h4>Sriram Cables</h4>
                                            <p class=" text-justify">In 2005, we established our state-of-the-art
                                                manufacturing
                                                facility in
                                                Chopanki
    ...
    <div id="founders" class="founders d-none"
        style="background-image: url('{{ asset('assets/images/7.png') }}');    background-size: cover;">
                    ...
                    <div class="row mb-5">
                        <div class="col-sm-4 text-center mb-5" data-aos="fade-up">
                            <img src="{{ asset('assets/images/person-1.png') }}"
                                class="img-fluid rounded-3 mb-3 founder-image">
                        ...
                        <div class="col-sm-4 text-center mb-5" data-aos="fade-up">
                            <img src="{{ asset('assets/images/person-3.png') }}"
                                class="img-fluid rounded-3 mb-3 founder-image">
                            <div class="text-center fs-4">
                                Mr. Sunil Garg
                            </div>
    ...
    <div class="work_with_us flex-column flex-md-row" id="whyus">
        ...
        <div class="bg-2"
            style="background-image: url('{{ asset('assets/images/bg-2.png') }}');    background-size: cover;">
